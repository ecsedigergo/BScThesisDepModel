...
/**
 * This is the item provider adapter for a {@link model.petriNetEMF.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addOutgoingArcsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_outgoingArcs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_outgoingArcs_feature", "_UI_Transition_type"),
				 PetriNetEMFPackage.Literals.TRANSITION__OUTGOING_ARCS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIncomingArcsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_incomingArcs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_incomingArcs_feature", "_UI_Transition_type"),
				 PetriNetEMFPackage.Literals.TRANSITION__INCOMING_ARCS,
				 true,
				 false,
				 true,
				 null,
