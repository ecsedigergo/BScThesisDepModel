		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComponentConnDecAccess().getNameAssignment_2(), "rule__ComponentConnDec__NameAssignment_2");
					...
					put(grammarAccess.getPortInAccess().getNameAssignment_3(), "rule__PortIn__NameAssignment_3");
					put(grammarAccess.getPortInAccess().getPortInSuperTypeAssignment_5(), "rule__PortIn__PortInSuperTypeAssignment_5");
					put(grammarAccess.getPortOutAccess().getNameAssignment_3(), "rule__PortOut__NameAssignment_3");
